...
int main()
{
	...
	/************************************************************************
	 * INPUT/PROCESSING/OUTPUT - Runs a program a test program a determined 
	 * amount of times to help the user total any amount of sheep while error
	 * checking to make sure they do not violate the natural order that is
	 * the proper ages of sheep. Uses For loop to test determined amount of
	 * times, do while loops to error check, and while loop to wait for the
	 * user to exit the program entirely. Outputs the average and what age
	 * group is the most dominant among them.
	 ***********************************************************************/
    cout << left;
